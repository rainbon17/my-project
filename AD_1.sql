...
set PATH=D:\Tools\java832\bin;%PATH%
...
java -jar schemaspy_6.0.0.jar -t db2jcc -dp 'c:/Program Files/IBM/SQLLIB/java/db2jcc4.jar' -db insdb  -schema users  -u DBDJ -p dbdj88 -o d:/dbdj88d    -gv D:\Tools\Graphviz2x.7\Graphviz2.38
java -jar schemaSpy_5.0.0.jar -t db2jcc -db insdb -u DBAD -p dbad88 -schema users -charset UTF-8 -o d:/dbad88c -gv D:\Tools\Graphviz2x.7\Graphviz2.38
